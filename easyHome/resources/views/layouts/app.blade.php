...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="flex py-5 bg-indigo-500 text-white">
        <div class="w-1/2 px-12 mr-auto">
            <p class="text-2xl font-bold">Easy Home</p>
        </div>
        ...
        @if(auth()->check())
            ...
            <li>
                <a href="{{route ('login.destroy') }}" class="font-semibold border-2 border-white py-2 px-4  rounded-md hover:bg-white hover:text-indigo-700">Logout</a>
            </li>
        @else
            <li class="mx-6">
